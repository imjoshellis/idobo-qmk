...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_ortho_5x15(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_CIRC, KC_AMPERSAND, KC_TRNS, KC_ASUP, KC_TRNS, KC_AT, KC_LPRN, KC_RPRN, ARROW, KC_TRNS, ARROW_FN, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_EXCLAIM, KC_PERC, KC_TRNS, KC_ASDN, KC_TRNS, KC_DOLLAR, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL, KC_GRAVE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ASTR, KC_TRNS, KC_ASRP, KC_TRNS, KC_HASH, KC_UNDS, KC_PLUS, KC_GT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
