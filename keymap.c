...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x15(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, C(A(KC_LEFT)), C(A(KC_UP)), C(A(KC_RIGHT)), KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, C(A(KC_E)), C(A(KC_DOWN)), C(A(KC_T)), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLASH, LCTL_T(KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, C(A(KC_D)), C(A(KC_F)), C(A(KC_G)), KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, LSFT_T(KC_TRNS), LT(1, KC_Z), KC_X, KC_C, KC_V, KC_B, KC_TRNS, KC_TRNS, KC_TRNS, KC_N, KC_M, KC_COMMA, KC_DOT, LT(2, KC_SLASH), KC_ENT, MO(4), LCA_T(KC_ESC), KC_LCTRL, KC_LALT, KC_LGUI, LT(2, KC_SPC), LSFT_T(KC_TAB), KC_NO, SGUI_T(KC_ENT), LT(1, KC_SPC), CMD_TAB, KC_NO, KC_NO, KC_NO, MO(3)),
    ...
    [2] = LAYOUT_ortho_5x15(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_CIRC, KC_AMPERSAND, KC_TRNS, KC_TRNS, KC_TRNS, KC_AT, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, FN_ARROW, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_EXCLAIM, KC_PERC, KC_TRNS, KC_TRNS, KC_TRNS, KC_DOLLAR, KC_LCBR, KC_RCBR, KC_MINS, KC_EQL, KC_GRAVE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ASTR, KC_TRNS, KC_TRNS, KC_TRNS, KC_HASH, KC_UNDS, KC_PLUS, KC_GT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
